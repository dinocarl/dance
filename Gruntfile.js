...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            styles: {
                files: ['<%= yeoman.app %>/styles/**/*.{css,sass,scss,less,styl}'],
                tasks: ['styles:dev']
            },
        ...
        stylus: {
            options: {
              banner: '/*\n * Built <%= grunt.template.today() %>.\n * Style management is handled through Stylus.\n * Edits to this file won\'t be permanent and will be lost on a subsequent recompile.\n */\n\n',
              compress: false
            },
            files: {
              expand: true,
